...
export default function LogoSquare({ width, height, className }: Props) {
  const t = useTranslation()
  const mergedClassName = 'w-full h-full' + (className ? ' ' + className : '')
  const dims = { ...(width !== undefined ? { width } : {}), ...(height !== undefined ? { height } : {}) }
  return (
    <svg
    ...
    >
      ...
      <g transform="translate(204,80)" filter="url(#glowGold)">
