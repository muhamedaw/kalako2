  ...
  return (
    ...
    >
      ...
      <g filter="url(#glowYellow)">
        <text x={256} y={340} textAnchor="middle" fontFamily="Cairo, Tajawal, 'Noto Sans Arabic', system-ui, sans-serif" fontWeight={900} fontSize={280} fill="url(#gradYellowBlue)">؟</text>
      </g>
      <text x={256} y={446} textAnchor="middle" fontFamily="Cairo, Tajawal, 'Noto Sans Arabic', system-ui, sans-serif" fontWeight={900} fontSize={56} fill="#FFFFFF" filter="url(#glowYellow)" letterSpacing="-1">تحدي الإجابات</text>
