...
export default function LogoSquare({ width = 512, height = 512, className }: Props) {
  ...
  return (
    ...
    >
      ...
      <g transform="translate(176,80)" filter="url(#glowGold)">
      ...
      <text x={256} y={446} textAnchor="middle" fontFamily="Cairo, Tajawal, 'Noto Sans Arabic', system-ui, sans-serif" fontWeight={900} fontSize={56} fill="#FFFFFF" filter="url(#glowGold)" letterSpacing="-1">تحدي الإجابات</text>
      <g filter="url(#glowLime)">
        <circle cx={86} cy={102} r={9} fill={COLORS.accentLime} />
      </g>
      <g filter="url(#glowGold)">
        <circle cx={430} cy={380} r={7} fill={COLORS.accentPink} />
      </g>
