    ...
    >
      <defs>
        ...
        <linearGradient id="ogCode" x1="0" y1="0" x2="1" y2="0">
          ...
          <stop offset="100%" stopColor={COLORS.bgStart} />
        </linearGradient>
      ...
      <g transform="translate(120, 80)" filter="url(#ogGlowAmber)">
        <path d="M0,30 L14,0 L28,22 L42,0 L56,30 Z M0,30 L56,30 L56,38 L0,38 Z" fill={COLORS.primary} stroke="#FFFFFF" strokeWidth={2} strokeLinejoin="round" />
        <circle cx={14} cy={0} r={4} fill={COLORS.accentLime} />
        <circle cx={28} cy={14} r={3} fill={COLORS.primary} />
        <circle cx={42} cy={0} r={4} fill={COLORS.accentPink} />
      </g>
      ...
      <text x={80} y={476} fontFamily="Cairo, Tajawal, 'Noto Sans Arabic', system-ui, sans-serif" fontWeight={600} fontSize={28} fill="#F5EDE4" opacity={0.85}>لعبة خداع جماعية • ادعُ ربعك!</text>
      ...
      <g transform="translate(640, 180)">
        <text x={0} y={0} fontFamily="Cairo, Tajawal, 'Noto Sans Arabic', system-ui, sans-serif" fontWeight={900} fontSize={34} fill={COLORS.primary} filter="url(#ogGlowAmber)">كود الغرفة</text>
        <g filter="url(#ogGlowPink)">
        ...
        <text x={0} y={278} fontFamily="Cairo, Tajawal, 'Noto Sans Arabic', system-ui, sans-serif" fontWeight={700} fontSize={22} fill="#F5EDE4" opacity={0.9}>kalako.app/join</text>
      ...
      <circle cx={1110} cy={600} r={3} fill={COLORS.primary} filter="url(#ogGlowAmber)" />
    </svg>
  )
}
