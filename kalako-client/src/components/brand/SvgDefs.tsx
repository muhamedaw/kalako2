...
export default function SvgDefs() {
  return (
    <defs>
      ...
      <linearGradient id="gradCoralLime" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0%" stopColor={COLORS.primary} />
        <stop offset="100%" stopColor={COLORS.accentLime} />
      </linearGradient>
      <linearGradient id="gradLimeCoral" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor={COLORS.accentLime} />
        <stop offset="100%" stopColor={COLORS.primary} />
      </linearGradient>
      <radialGradient id="gradCoralPop" cx="50%" cy="50%" r="60%">
      ...
      <filter id="glowLime" x="-60%" y="-60%" width="220%" height="220%">
        <feGaussianBlur stdDeviation="2.5" result="b" in="SourceGraphic" />
        <feFlood floodColor={COLORS.accentLime} floodOpacity={0.85} />
        <feComposite in2="b" operator="in" result="glow" />
        <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
      </filter>
      <filter id="glowGreen" x="-60%" y="-60%" width="220%" height="220%">
        <feGaussianBlur stdDeviation="2" result="b" in="SourceGraphic" />
        <feFlood floodColor={COLORS.accentLime} floodOpacity={0.9} />
        <feComposite in2="b" operator="in" result="glow" />
        <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
      </filter>
      ...
      <filter id="softBlob" x="-60%" y="-60%" width="220%" height="220%">
        ...
        <feFlood floodColor={COLORS.primary} floodOpacity={0.55} />
        <feComposite in2="b" operator="in" result="glow" />
        <feMerge><feMergeNode in="glow" /><feMergeNode in="SourceGraphic" /></feMerge>
      </filter>
