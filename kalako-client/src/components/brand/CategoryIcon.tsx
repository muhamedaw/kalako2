...
export default function CategoryIcon({ categoryId, size = 512, className }: Props) {
  ...
  return (
    ...
    >
      <SvgDefs />
      <rect x={0} y={0} width={512} height={512} rx={44} ry={44} fill="url(#gradBg)" stroke={COLORS.primary} strokeWidth={6} filter="url(#glowCoral)" />
      <rect x={14} y={14} width={484} height={484} rx={32} ry={32} fill="none" stroke="#F5EDE4" strokeOpacity={0.18} strokeWidth={2} />
      <circle cx={430} cy={82} r={14} fill={cat.accent} filter="url(#glowCoral)" />
